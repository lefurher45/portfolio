...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ao(e,t,n){let r=new Float32Array(Ga),i=new H(0,1,0);return new ji({name:`SphericalGaussianBlur`,defines:{n:Ga,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:co(),fragmentShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Ds(i,i.VERTEX_SHADER,y),S=Ds(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Ns(i,x,`vertex`),n=Ns(i,S,`fragment`);z(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`;function el(e,t,n,r){let i=new Float32Array(e*3),a=new Float32Array(e),o=new Float32Array(e);for(let n=0;n<e;n++)i[n*3]=(Math.random()-.5)*t.x,i[n*3+1]=(Math.random()-.5)*t.y,i[n*3+2]=-Math.random()*t.z-50,a[n]=Math.random()*r[1]+r[0],o[n]=Math.random()*Math.PI*2;let s=new Er;return s.setAttribute(`position`,new dr(i,3)),s.setAttribute(`aSize`,new dr(a,1)),s.setAttribute(`aPhase`,new dr(o,1)),new fi(s,new ji({uniforms:{uTime:{value:0},uAnimate:{value:1},uColor:{value:new K(n)}},vertexShader:Jc,fragmentShader:Yc,transparent:!0,depthWrite:!1,blending:2}))}function tl(){let e=document.createElement(`canvas`);e.width=256,e.height=256;let t=e.getContext(`2d`);t.fillStyle=`#808080`,t.fillRect(0,0,256,256);for(let e=0;e<500;e++){let e=Math.random()*256,n=Math.random()*256,r=Math.random()*10+2,i=Math.floor(Math.random()*90+90);t.beginPath(),t.arc(e,n,r,0,Math.PI*2),t.fillStyle=`rgba(${i},${i},${i},0.35)`,t.fill()}let n=new hi(e);return n.wrapS=v,n.wrapT=v,n}function nl(){let e=(0,g.useRef)(null);return(0,g.useEffect)(()=>{let t=e.current;if(!t)return;let n=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,r=window.innerWidth<700,i=new Mn,a=new la(55,window.innerWidth/window.innerHeight,.1,2e3);a.position.z=60;let o=new Kc({alpha:!0,antialias:!0,powerPreference:`low-power`});o.setClearColor(0,0),o.setPixelRatio(Math.min(window.devicePixelRatio,1.5)),o.setSize(window.innerWidth,window.innerHeight),t.appendChild(o.domElement);let s=new pa(16777215,.35);i.add(s);let c=new fa(16777215,1.4);c.position.set(-60,40,80),i.add(c);let l=new fa(10466520,.4);l.position.set(50,-30,-40),i.add(l);let u=new bi(2,2),d=new ji({uniforms:{uTime:{value:0},uAnimate:{value:+!n}},vertexShader:Xc,fragmentShader:Zc,transparent:!0,depthWrite:!1}),f=new Yr(u,d);f.position.z=-400,f.scale.set(900,900,1),i.add(f);let p=r?550:1100,m=r?260:550,h=el(p,{x:700,y:500,z:500},16777215,[.6,1.6]),g=el(m,{x:500,y:380,z:250},16777215,[1.1,2.2]);i.add(h),i.add(g);let _=tl(),v=r?28:48,y=r?[{radius:6,x:-24,y:12,z:-80,color:15000804,rough:.85,spin:.16,drift:[1.6,.5]},{radius:3.4,x:26,y:-14,z:-55,color:12174550,rough:.6,spin:.24,drift:[-1.2,.8]},{radius:8.5,x:18,y:20,z:-150,color:10133672,rough:.9,spin:.1,drift:[-.8,-.5],ring:!0},{radius:2.6,x:-30,y:-18,z:-40,color:16777215,rough:.4,spin:.3,drift:[1,1.1]}]:[{radius:7.5,x:-30,y:16,z:-90,color:15000804,rough:.85,spin:.16,drift:[1.6,.5]},{radius:4.2,x:32,y:-12,z:-60,color:12174550,rough:.6,spin:.24,drift:[-1.2,.8]},{radius:11,x:22,y:24,z:-170,color:10133672,rough:.9,spin:.1,drift:[-.8,-.5],ring:!0},{radius:3,x:-38,y:-20,z:-45,color:16777215,rough:.4,spin:.32,drift:[1,1.1]},{radius:5.5,x:6,y:-30,z:-120,color:13085071,rough:.75,spin:.14,drift:[.6,-.9]},{radius:2.2,x:-12,y:32,z:-35,color:16777215,rough:.3,spin:.35,drift:[-1.5,-.6]},{radius:9,x:40,y:6,z:-200,color:9410467,rough:.95,spin:.08,drift:[-.5,.4]},{radius:3.6,x:-46,y:-4,z:-70,color:14207408,rough:.65,spin:.22,drift:[1.3,-.7]}],b=r?42:60,x=r?32:42,S=y.map(e=>{let t=new wn;t.position.set(e.x,e.y,e.z);let n=new Yr(new Si(e.radius,v,v),new Ni({color:e.color,roughness:e.rough,metalness:.15,bumpMap:_,bumpScale:.35}));n.rotation.x=Math.random()*Math.PI,n.rotation.z=(Math.random()-.5)*.6,t.add(n);let r=new Si(e.radius*1.04,v,v),a=new ji({uniforms:{uColor:{value:new K(e.color)},uIntensity:{value:.55}},vertexShader:Qc,fragmentShader:$c,transparent:!0,blending:2,side:0,depthWrite:!1});if(t.add(new Yr(r,a)),e.ring){let n=new Yr(new xi(e.radius*1.5,e.radius*2.1,64),new Ni({color:13619151,roughness:.8,metalness:.1,side:2,transparent:!0,opacity:.55}));n.rotation.x=Math.PI/2.4,t.add(n)}return i.add(t),{group:t,mesh:n,spin:e.spin,drift:{x:e.drift[0],y:e.drift[1]}}}),C=null,w=performance.now(),T=!0,E={time:0};function D(){o.render(i,a)}function O(e){if(!T)return;let t=Math.min((e-w)/1e3,.1);w=e,E.time+=t,h.material.uniforms.uTime.value=E.time,g.material.uniforms.uTime.value=E.time,d.uniforms.uTime.value=E.time,S.forEach(({group:e,mesh:n,spin:r,drift:i})=>{n.rotation.y+=t*r,n.rotation.x+=t*r*.25,e.position.x+=i.x*t,e.position.y+=i.y*t,e.position.x>b&&(e.position.x=-b),e.position.x<-b&&(e.position.x=b),e.position.y>x&&(e.position.y=-x),e.position.y<-x&&(e.position.y=x)}),o.render(i,a),C=requestAnimationFrame(O)}n?(h.material.uniforms.uAnimate.value=0,g.material.uniforms.uAnimate.value=0,D()):C=requestAnimationFrame(O);function k(){a.aspect=window.innerWidth/window.innerHeight,a.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight),n&&D()}window.addEventListener(`resize`,k);function A(){n||(document.hidden?(T=!1,C&&cancelAnimationFrame(C)):T||(T=!0,w=performance.now(),C=requestAnimationFrame(O)))}return document.addEventListener(`visibilitychange`,A),()=>{T=!1,C&&cancelAnimationFrame(C),window.removeEventListener(`resize`,k),document.removeEventListener(`visibilitychange`,A),_.dispose(),i.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&e.material.dispose()}),o.dispose(),t.contains(o.domElement)&&t.removeChild(o.domElement)}},[]),(0,Q.jsx)(`div`,{ref:e,className:`space-bg`,"aria-hidden":`true`})}var rl=`data:image/svg+xml;base64,`,il=[{href:`#a-propos`,label:`À propos`},{href:`#competences`,label:`Compétences`},{href:`#services`,label:`Services`},{href:`#certifications`,label:`Certifications`},{href:`#projets`,label:`Projets`},{href:`#contact`,label:`Contact`}];function al(){let[e,t]=(0,g.useState)(!1),[n,r]=(0,g.useState)(!1);return(0,g.useEffect)(()=>{let e=()=>t(window.scrollY>12);return window.addEventListener(`scroll`,e),()=>window.removeEventListener(`scroll`,e)},[]),(0,Q.jsxs)(`header`,{style:{position:`fixed`,top:0,left:0,right:0,zIndex:50,background:e?`rgba(10,10,10,0.92)`:`transparent`,borderBottom:e?`1px solid var(--border-dark)`:`1px solid transparent`,backdropFilter:`blur(6px)`,transition:`background 0.2s ease, border-color 0.2s ease`},children:[(0,Q.jsxs)(`nav`,{className:`container`,style:{display:`flex`,alignItems:`center`,justifyContent:`space-between`,height:76},children:[(0,Q.jsxs)(`a`,{href:`#top`,style:{display:`flex`,alignItems:`center`,gap:10},children:[(0,Q.jsx)(`img`,{src:rl,alt:`Logo Adolphe PANA`,width:`32`,height:`32`}),(0,Q.jsx)(`span`,{className:`display`,style:{fontSize:20},children:`P.W.E.A`})]}),(0,Q.jsx)(`div`,{className:`desktop-links`,style:{display:`flex`,gap:32},children:il.map(e=>(0,Q.jsx)(`a`,{href:e.href,className:`label`,style:{color:`var(--text-on-dark-secondary)`},children:e.label},e.href))}),(0,Q.jsx)(`a`,{href:`#contact`,className:`btn desktop-cta`,children:`Me contacter`}),(0,Q.jsx)(`button`,{"aria-label":`Ouvrir le menu`,className:`menu-btn`,onClick:()=>r(!n),style:{display:`none`,background:`none`,border:`1px solid var(--border-dark)`,borderRadius:8,width:40,height:40,color:`#fff`},children:n?`×`:`≡`})]}),n&&(0,Q.jsxs)(`div`,{className:`container`,style:{paddingBottom:20,display:`flex`,flexDirection:`column`,gap:16},children:[il.map(e=>(0,Q.jsx)(`a`,{href:e.href,onClick:()=>r(!1),className:`label`,style:{color:`#fff`},children:e.label},e.href)),(0,Q.jsx)(`a`,{href:`#contact`,className:`btn`,onClick:()=>r(!1),children:`Me contacter`})]}),(0,Q.jsx)(`style`,{children:`
        @media (max-width: 860px) {
          .desktop-links, .desktop-cta { display: none !important; }
          .menu-btn { display: block !important; }
        }
      `})]})}var ol={name:`Adolphe PANA`,fullName:`PANA Wiyaou Essodong Adolphe`,title:`Etudiant en sécurité informatique — Administration système`,tagline:`Sécurité réseau et administration système. Passionné par l'étude des attaques et les simulations.`,location:`Lomé, Togo`,email:`adolpheapana@gmail.com`,phone:`+228 91 17 08 20`,github:`https://github.com/lefurher45`,linkedin:`https://www.linkedin.com/in/adolphe-pana`,cvFile:`/cv-adolphe-pana.pdf`,photo:``,bio:` Etudiant en deuxième année de licence professionnelle (IRT2) à ESGIS, spécialisé en sécurité informatique. Je maîtrise les environnements Linux et Windows, la virtualisation et les tests en laboratoire. Curieux et rigoureux, je développe mes compétences en programmation  tout en explorant les techniques d'attaque et de défense en environnement contrôlé.`},sl=`/assets/portrait-DkxfZ8_8.png`;function $({children:e,delay:t=0,as:n=`div`,className:r=``}){let i=(0,g.useRef)(null),[a,o]=(0,g.useState)(!1);return(0,g.useEffect)(()=>{let e=i.current;if(!e)return;let t=new IntersectionObserver(([e])=>{e.isIntersecting&&(o(!0),t.disconnect())},{threshold:.15});return t.observe(e),()=>t.disconnect()},[]),(0,Q.jsx)(n,{ref:i,className:`reveal ${a?`is-visible`:``} ${r}`,style:{transitionDelay:`${t}ms`},children:e})}function cl(){return(0,Q.jsxs)(`section`,{id:`top`,style:{paddingTop:160,borderBottom:`1px solid var(--border-dark)`},children:[(0,Q.jsxs)(`div`,{className:`container hero-grid`,children:[(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)($,{children:(0,Q.jsx)(`span`,{className:`label`,children:`Sécurité informatique`})}),(0,Q.jsx)($,{delay:80,children:(0,Q.jsx)(`h1`,{className:`display`,style:{fontSize:`clamp(48px, 8vw, 92px)`,margin:`18px 0`},children:ol.name})}),(0,Q.jsx)($,{delay:140,children:(0,Q.jsx)(`p`,{style:{fontSize:20,color:`var(--text-on-dark-secondary)`,maxWidth:480,marginBottom:12},children:ol.title})}),(0,Q.jsx)($,{delay:200,children:(0,Q.jsx)(`p`,{style:{fontSize:15,color:`var(--text-on-dark-secondary)`,maxWidth:460,lineHeight:1.7},children:ol.tagline})}),(0,Q.jsx)($,{delay:280,children:(0,Q.jsxs)(`div`,{style:{display:`flex`,gap:16,marginTop:36,flexWrap:`wrap`},children:[(0,Q.jsx)(`a`,{className:`btn`,href:ol.cvFile,download:!0,children:`Télécharger le CV`}),(0,Q.jsx)(`a`,{className:`btn btn-outline`,href:`#projets`,children:`Voir les projets`})]})})]}),(0,Q.jsx)($,{delay:12,className:`hero-photo-wrap`,children:(0,Q.jsx)(`div`,{className:`hero-photo-frame`,children:(0,Q.jsx)(`img`,{src:sl,alt:ol.name,className:`hero-photo`})})})]}),(0,Q.jsx)(`style`,{children:`
        .hero-grid {
          display: grid;
      ...
      `})]})}var ll={education:[{year:`2025 — en cours`,title:`Licence professionnelle IRT2`,place:`ESGIS`},{year:`2024`,title:`BAC II, série D`,place:`Lycée Notre Dame de l'Église (NDE)`},{year:`2023`,title:`BAC I, série D `,place:`LSCRM`}],work:[{period:`Stage / Projet pratique`,role:`Automatisation des tâches et emails`,place:`W3frame`,points:[`Mise en place de workflows automatisés avec n8n pour simplifier les tâches répétitives.`,`Optimisation des processus internes de l'entreprise pour gagner du temps et réduire les erreurs.`,`Acquisition de compétences pratiques en automatisation et en gestion d'outils numériques.`]},{period:` Projet pratique`,role:`chargé de la sécurité de l'application`,place:`Novamind`,points:[`Analyse et test des vulnérabilités de l'application.`,`Mise en place de mesures de sécurité pour protéger les données des utilisateurs.`,`Collaboration avec l'équipe de développement pour intégrer les meilleures pratiques de sécurité dans le cycle de vie du projet.`]}]};function ul(){return(0,Q.jsxs)(`section`,{id:`a-propos`,children:[(0,Q.jsxs)(`div`,{className:`container`,children:[(0,Q.jsx)($,{children:(0,Q.jsx)(`span`,{className:`label`,children:`À propos`})}),(0,Q.jsx)($,{delay:60,children:(0,Q.jsx)(`h2`,{className:`display`,style:{fontSize:`clamp(32px, 5vw, 56px)`,margin:`14px 0 40px`},children:`Profil & parcours`})}),(0,Q.jsxs)(`div`,{className:`about-grid`,children:[(0,Q.jsx)($,{children:(0,Q.jsx)(`p`,{style:{fontSize:17,lineHeight:1.8,color:`var(--text-on-dark-secondary)`,maxWidth:640},children:ol.bio})}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)($,{delay:80,children:(0,Q.jsx)(`h3`,{className:`label`,style:{marginBottom:18},children:`Formation`})}),ll.education.map((e,t)=>(0,Q.jsx)($,{delay:100+t*60,children:(0,Q.jsxs)(`div`,{className:`timeline-row`,children:[(0,Q.jsx)(`span`,{className:`label`,style:{minWidth:96,color:`var(--label-neutral)`},children:e.year}),(0,Q.jsxs)(`div`,{children:[(0,Q.jsx)(`div`,{style:{fontWeight:700},children:e.title}),(0,Q.jsx)(`div`,{style:{fontSize:13,color:`var(--text-on-dark-secondary)`},children:e.place})]})]})},e.title)),(0,Q.jsx)($,{delay:260,children:(0,Q.jsx)(`h3`,{className:`label`,style:{margin:`32px 0 18px`},children:`Expérience`})}),ll.work.map((e,t)=>(0,Q.jsx)($,{delay:300+t*60,children:(0,Q.jsxs)(`div`,{style:{marginBottom:20},children:[(0,Q.jsxs)(`div`,{style:{fontWeight:700},children:[e.role,` — `,e.place]}),(0,Q.jsx)(`div`,{className:`label`,style:{margin:`4px 0 10px`},children:e.period}),(0,Q.jsx)(`ul`,{style:{margin:0,paddingLeft:18,color:`var(--text-on-dark-secondary)`,fontSize:14,lineHeight:1.8},children:e.points.map(e=>(0,Q.jsx)(`li`,{children:e},e))})]})},e.place))]})]})]}),(0,Q.jsx)(`style`,{children:`
        .about-grid {
          display: grid;
      ...
      `})]})}var pl=[{id:`okay`,title:`Audit de sécurité`,description:`Analyse de votre infrastructure (réseau, postes, serveurs) pour identifier les vulnérabilités et vous proposer un plan de remédiation priorisé.`,icon:`shield`},{id:`upervision-reseau`,title:`Supervision réseau`,description:`Mise en place d'outils de monitoring pour surveiller la disponibilité, les performances et détecter les incidents en temps réel.`,icon:`radar`},{id:`automatisation`,title:`Automatisation de tâches`,description:`Scripts et outils pour automatiser les tâches d'administration système récurrentes (sauvegardes, déploiements, contrôles).`,icon:`gear`},{id:`formation-sensibilisation`,title:`Formation & sensibilisation`,description:`Sessions de sensibilisation aux bonnes pratiques de cybersécurité pour vos équipes : phishing, mots de passe, hygiène numérique.`,icon:`users`}],ml={shield:(0,Q.jsxs)(`svg`,{viewBox:`0 0 24 24`,width:`26`,height:`26`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.5`,children:[(0,Q.jsx)(`path`,{d:`M12 3l7 3v5.2c0 4.6-3 8.4-7 9.8-4-1.4-7-5.2-7-9.8V6l7-3z`,strokeLinejoin:`round`}),(0,Q.jsx)(`path`,{d:`M9 12l2 2 4-4.2`,strokeLinecap:`round`,strokeLinejoin:`round`})]}),radar:(0,Q.jsxs)(`svg`,{viewBox:`0 0 24 24`,width:`26`,height:`26`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.5`,children:[(0,Q.jsx)(`circle`,{cx:`12`,cy:`12`,r:`9`}),(0,Q.jsx)(`circle`,{cx:`12`,cy:`12`,r:`5`}),(0,Q.jsx)(`circle`,{cx:`12`,cy:`12`,r:`1.2`,fill:`currentColor`,stroke:`none`}),(0,Q.jsx)(`path`,{d:`M12 12L19 7`,strokeLinecap:`round`})]}),gear:(0,Q.jsxs)(`svg`,{viewBox:`0 0 24 24`,width:`26`,height:`26`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.5`,children:[(0,Q.jsx)(`circle`,{cx:`12`,cy:`12`,r:`3.2`}),(0,Q.jsx)(`path`,{d:`M12 3v2.2M12 18.8V21M21 12h-2.2M5.2 12H3M18.4 5.6l-1.5 1.5M7.1 16.9l-1.5 1.5M18.4 18.4l-1.5-1.5M7.1 7.1L5.6 5.6`,strokeLinecap:`round`})]}),users:(0,Q.jsxs)(`svg`,{viewBox:`0 0 24 24`,width:`26`,height:`26`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.5`,children:[(0,Q.jsx)(`circle`,{cx:`9`,cy:`8.5`,r:`3`}),(0,Q.jsx)(`path`,{d:`M3.5 20c0-3 2.5-5 5.5-5s5.5 2 5.5 5`,strokeLinecap:`round`}),(0,Q.jsx)(`path`,{d:`M16 4.5c1.5 0.4 2.5 1.7 2.5 3.2 0 1.4-.9 2.7-2.2 3.1`,strokeLinecap:`round`}),(0,Q.jsx)(`path`,{d:`M15.5 15.2c2.5.5 4.5 2.4 4.5 4.8`,strokeLinecap:`round`})]})};function hl(e){e.preventDefault();let t=document.getElementById(`contact`);t&&t.scrollIntoView({behavior:`smooth`})}function gl(){return(0,Q.jsxs)(`section`,{id:`services`,children:[(0,Q.jsxs)(`div`,{className:`container`,children:[(0,Q.jsx)($,{children:(0,Q.jsx)(`span`,{className:`label`,children:`Services`})}),(0,Q.jsx)($,{delay:60,children:(0,Q.jsx)(`h2`,{className:`display`,style:{fontSize:`clamp(32px, 5vw, 56px)`,margin:`14px 0 40px`},children:`Ce que je propose`})}),(0,Q.jsx)(`div`,{className:`svc-grid`,children:pl.map((e,t)=>(0,Q.jsx)($,{delay:t*80,children:(0,Q.jsxs)(`div`,{className:`svc-card`,children:[(0,Q.jsx)(`div`,{className:`svc-icon`,children:e.image?(0,Q.jsx)(`img`,{src:e.image,alt:``}):ml[e.icon]||ml.shield}),(0,Q.jsx)(`div`,{style:{fontWeight:700,fontSize:17,marginTop:18},children:e.title}),(0,Q.jsx)(`p`,{style:{fontSize:14,color:`var(--text-on-dark-secondary)`,lineHeight:1.7,marginTop:8,flex:1},children:e.description}),(0,Q.jsx)(`a`,{href:`#contact`,onClick:hl,className:`btn btn-outline svc-btn`,children:`Me contacter`})]})},e.id))})]}),(0,Q.jsx)(`style`,{children:`
        .svc-grid {
          display: grid;
      ...
      `})]})}function xl(){return(0,Q.jsxs)(`section`,{id:`contact`,children:[(0,Q.jsxs)(`div`,{className:`container`,children:[(0,Q.jsx)($,{children:(0,Q.jsx)(`span`,{className:`label`,children:`Contact`})}),(0,Q.jsx)($,{delay:60,children:(0,Q.jsx)(`h2`,{className:`display`,style:{fontSize:`clamp(32px, 5vw, 56px)`,margin:`14px 0 24px`},children:`Discutons`})}),(0,Q.jsx)($,{delay:100,children:(0,Q.jsx)(`p`,{style:{color:`var(--text-on-dark-secondary)`,maxWidth:480,marginBottom:40,lineHeight:1.7},children:`Disponible pour des stages, des projets pratiques ou toute opportunité en sécurité informatique et administration système.`})}),(0,Q.jsxs)(`div`,{className:`contact-grid`,children:[(0,Q.jsx)($,{delay:140,children:(0,Q.jsxs)(`a`,{href:`mailto:${ol.email}`,className:`contact-row`,children:[(0,Q.jsx)(`span`,{className:`label`,children:`Email`}),(0,Q.jsx)(`span`,{children:ol.email})]})}),(0,Q.jsx)($,{delay:180,children:(0,Q.jsxs)(`a`,{href:`https://wa.me/${ol.phone.replace(/\D/g,``)}`,className:`contact-row`,children:[(0,Q.jsx)(`span`,{className:`label`,children:`Téléphone / WhatsApp`}),(0,Q.jsx)(`span`,{children:ol.phone})]})}),(0,Q.jsx)($,{delay:220,children:(0,Q.jsxs)(`a`,{href:ol.github,target:`_blank`,rel:`noreferrer`,className:`contact-row`,children:[(0,Q.jsx)(`span`,{className:`label`,children:`GitHub`}),(0,Q.jsx)(`span`,{children:ol.github.replace(`https://`,``)})]})}),(0,Q.jsx)($,{delay:260,children:(0,Q.jsxs)(`a`,{href:ol.linkedin,target:`_blank`,rel:`noreferrer`,className:`contact-row`,children:[(0,Q.jsx)(`span`,{className:`label`,children:`LinkedIn`}),(0,Q.jsx)(`span`,{children:ol.linkedin.replace(`https://`,``)})]})}),(0,Q.jsx)($,{delay:300,children:(0,Q.jsxs)(`div`,{className:`contact-row`,style:{cursor:`default`},children:[(0,Q.jsx)(`span`,{className:`label`,children:`Localisation`}),(0,Q.jsx)(`span`,{children:ol.location})]})})]})]}),(0,Q.jsx)(`style`,{children:`
      ...
      `})]})}function Sl(){return(0,Q.jsx)(`footer`,{style:{padding:`32px 0`,borderTop:`1px solid var(--border-dark)`},children:(0,Q.jsxs)(`div`,{className:`container`,style:{display:`flex`,justifyContent:`space-between`,flexWrap:`wrap`,gap:12},children:[(0,Q.jsxs)(`span`,{className:`label`,children:[`© `,new Date().getFullYear(),` Adolphe PANA`]}),(0,Q.jsx)(`span`,{className:`label`,children:`Sécurité informatique · Lomé, Togo`})]})})}function Cl(){return(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(nl,{}),(0,Q.jsx)(al,{}),(0,Q.jsxs)(`main`,{children:[(0,Q.jsx)(cl,{}),(0,Q.jsx)(ul,{}),(0,Q.jsx)(fl,{}),(0,Q.jsx)(gl,{}),(0,Q.jsx)(vl,{}),(0,Q.jsx)(bl,{}),(0,Q.jsx)(xl,{})]}),(0,Q.jsx)(Sl,{})]})}_.createRoot(document.getElementById(`root`)).render((0,Q.jsx)(g.StrictMode,{children:(0,Q.jsx)(Cl,{})}));